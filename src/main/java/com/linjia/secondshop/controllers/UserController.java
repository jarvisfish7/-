...
import com.linjia.secondshop.models.*;
import com.linjia.secondshop.services.*;
import com.linjia.secondshop.utils.FileCheck;
import com.linjia.secondshop.utils.InfoCheck;
import com.linjia.secondshop.utils.RandomString;
...
public class UserController {
	...
	@RequestMapping(value = "recharge/{money}&{userId}", method = RequestMethod.GET)
	public ResponseEntity rechargeToCount(@PathVariable int money, @PathVariable Integer userId,ModelMap model,HttpSession session) {
		User user = (User)session.getAttribute("user");
		user.setCount(user.getCount() + money);
		session.setAttribute("user", user);
		boolean flag = userService.rechargeToCount(money,userId);
